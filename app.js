...
function startConfiguredQuiz(){
 ...
 for(let i=0;i<count;i++) questions.push({char:chars[i%chars.length],type:type==="mixed"?["sound","part"][i%2]:type});
